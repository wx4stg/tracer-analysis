...
plt.scatter([0.1, 1.0], [N01_1, N1_1], color="red", label="pyrcel number activated CCN")
if len(A) > 1:
    plt.scatter([0.1, 1.0], [105.4672808, 1453.627972], color="blue", label='modeloutput.xlsx')
plt.xscale("log")
plt.yscale("log")
plt.xlim([0.01, 2.0])
plt.ylim([.1, 3000])
